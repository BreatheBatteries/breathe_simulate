...
- Example notebook Pulse Heating works through the whole study: the resistance curve, the maximum-amplitude table, and a closed-loop heat-up from -20 °C.

Both new calculations are evaluated at a rest state rather than simulated, so they return in seconds rather than requiring a full simulation.
